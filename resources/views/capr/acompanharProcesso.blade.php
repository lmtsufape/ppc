...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        ...
        <div class="modal-body">
            <form method="POST" action="{{ route('capr.novoParecer') }}" enctype="multipart/form-data" id="formErrata">
...
<div class="modal fade" id="exampleModal1" tabindex="-1" role="dialog" aria-labelledby="exampleModal1Label" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        ...
        <div class="modal-body">
            <form method="POST" action="{{ route('capr.modificarArquivo') }}" enctype="multipart/form-data" id="formErrata1">
                        ...
                        <div class="card-header" id="heading{{$i}}">
                                <div class="col-sm-12">
                                    ...
                                    role="button" aria-expanded="false" aria-controls="collapseProcesso{{$i}}">
                                        <img id="img" style="float:left" class="img icone-processo" src="{{asset('images/plus-solid.svg')}}" alt="">
                                    </a>
                                    <?php
